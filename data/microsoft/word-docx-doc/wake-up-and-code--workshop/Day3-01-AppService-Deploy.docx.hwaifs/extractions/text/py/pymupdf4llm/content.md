...
To troubleshoot an App Service deployment issue, see Troubleshoot ASP.NET Core startup errors on Azure App Service. 
...
Visual Studio publish profiles for ASP.NET Core app deployment Troubleshoot ASP.NET Core startup errors on Azure App Service 
