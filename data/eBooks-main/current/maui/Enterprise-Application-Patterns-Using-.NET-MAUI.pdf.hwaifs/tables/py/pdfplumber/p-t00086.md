|    | 0                   | 1                                                 |
|---:|:--------------------|:--------------------------------------------------|
|  0 | Authentication Flow | Description                                       |
|  1 | Implicit            | This flow is optimized for browser-based          |
...
|    |                     | permitted.                                        |
|  2 | Authorization code  | This flow provides the ability to retrieve tokens |
|    |                     | on a back channel, as opposed to the browser      |
|    |                     | front channel, while also supporting client       |
|    |                     | authentication.                                   |
|  3 | Hybrid              | This flow is a combination of the implicit and    |
