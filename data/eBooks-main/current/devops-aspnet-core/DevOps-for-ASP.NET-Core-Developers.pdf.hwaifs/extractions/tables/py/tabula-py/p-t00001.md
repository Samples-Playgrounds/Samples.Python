...
|  1 |    4 | Commit the file to the local Git repository, using either the Changes page in Visual Studio’s |
...
|  4 |    5 | Using the local machine’s command shell, add the staging deployment URL as a Git remote       |
