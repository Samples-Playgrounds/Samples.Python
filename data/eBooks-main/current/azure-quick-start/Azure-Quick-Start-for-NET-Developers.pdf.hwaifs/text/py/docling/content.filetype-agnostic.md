...
To read more about how Azure secures your applications and data, read the official Azure Security blog , Azure Security Overview
, w
, a and how to get started with Azure Security . We've briefly explored reasons to begin your migration to the cloud and Microsoft Azure. Now, let's examine which Azure services are useful for you for running and securing your applications and storing your data.
...
Try it now w -G Get started by creating an ASP.NET Core G web app in Azure
...
## Here's an e example e :

A logic app gets triggered by a new blob that is written in Azure Blob storage . . It takes the Blob input, which is an image file, and resizes the image by calling an Azure function that does just that. Next, it takes the resized image and writes it to another storage account. And finally, it calls the O Office 365 AP O I to send an email to the administrator that there is a new, resized image available.
...
Get started by building your first logic app workflow in the Azure porta l l . .
...
G e et started by managing your Azure resources with Cloud Explorer. e.
...
Get started by configuring and using the storage emulator o with Visual Studio. o.
...
Get started by creating your first function using Visual Studio an d d test it locally. y.
