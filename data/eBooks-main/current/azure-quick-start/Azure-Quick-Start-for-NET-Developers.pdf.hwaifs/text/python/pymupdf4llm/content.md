...
|AppService<br>WebApps<br>Monolithic<br>and N -Tier<br>applications|Col2|AppService<br>Mobile<br>Apps|Azure<br>Functions|LogicApps|Virtual<br>Machines<br>*|Azure<br>Kubernetes<br>Service(AKS)|Container<br>Instances|
|---|---|---|---|---|---|---|---|
|**Mobile app**<br>**back end**|||||*|||
|**Microservice**<br>**architecture-**<br>**based**<br>**applications**||||||||
|**Business process**<br>**orchestrations**<br>**and workflows**||||||||
...
|NETFramework<br>.<br>apps|WebApps|Mobile<br>Apps|Functions|AzureVMs|Azure<br>Container<br>Instance|Azure<br>Kubernetes<br>Service<br>(AKS)|
|---|---|---|---|---|---|---|
|**.NET Core apps**|||||||
|**Linux Containers**|||||||
...
|Database CosmosDB Blob<br>Relationaldata|Col2|Col3|Col4|Table|File|PostgreSQL<br>,<br>MySQL|SQLData<br>Warehouse|DataLake<br>Store|
|---|---|---|---|---|---|---|---|---|
