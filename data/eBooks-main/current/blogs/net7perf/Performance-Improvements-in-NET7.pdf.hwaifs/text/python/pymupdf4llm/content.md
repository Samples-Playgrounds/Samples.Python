...
occurrences of `SafeHandle` s being left for finalization (many thanks to the diagnostics put in place in
...
[shipped publicly). dotnet/runtime#67714 added support for user-defined](https://github.com/dotnet/runtime/pull/67714) `checked` operators, a new
...
[Finally, there’s dotnet/runtime#63794, which recognizes that a](https://github.com/dotnet/runtime/pull/63794) `MemoryMappedViewAccessor` or
...
otherwise fall back to the old approach of heap-allocating the `bool[]` (which can also then be stored
