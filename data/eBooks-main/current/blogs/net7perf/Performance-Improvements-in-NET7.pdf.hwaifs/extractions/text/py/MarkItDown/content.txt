...
multiplication of two 32-bit integers to be done with smull/umull. And dotnet/runtime#61549
...
dotnet/runtime#61638 for most of the other I/O-related libraries, and a long-tail of additional
...
of _dateData but with the top two bits masked out, e.g. _dateData & 0x3FFFFFFFFFFFFFFF. The
...
0x3FFFFFFFFFFFFFFF). However, as a micro-optimization that can instead be expressed more
...
FILE_SKIP_COMPLETION_PORT_ON_SUCCESS completion notification mode on the socket; use of this
...
System.Security.Cryptography.Algorithms.dll, System.Security.Cryptography.Cng.dll,
...
dotnet/runtime#69024 from [@vcsjones](https://github.com/vcsjones), dotnet/runtime#71015
...
dotnet/runtime#64357 adds the new ArgumentException.ThrowIfNullOrEmpty helper as well as
...
my .NET 6 performance post, I talked about some of the overheads possible when types aren’t sealed:
