|    | 0                                                                  |
|---:|:-------------------------------------------------------------------|
|  0 | private readonly char[] s_target = new[] { 'z', 'q' };             |
|  1 | const string Sonnet = """                                          |
...
|  7 | And often is his gold complexion dimm'd;                           |
|  8 | And every fair from fair sometime declines,                        |
|  9 | By chance or nature's changing course untrimm'd;                   |
| 10 | But thy eternal summer shall not fade,                             |
| 11 | Nor lose possession of that fair thou ow'st;                       |
| 12 | Nor shall death brag thou wander'st in his shade,                  |
...
| 17 |                                                                    |
| 18 | [Benchmark]                                                        |
| 19 | public int LastIndexOfAny() => Sonnet.LastIndexOfAny(s_target);    |
| 20 |                                                                    |
| 21 | [Benchmark]                                                        |
| 22 | public int CountLines()                                            |
| 23 | {                                                                  |
| 24 | int count = 0;                                                     |
| 25 | foreach (ReadOnlySpan<char> _ in Sonnet.AsSpan().EnumerateLines()) |
| 26 | {                                                                  |
| 27 | count++;                                                           |
| 28 | }                                                                  |
| 29 |                                                                    |
