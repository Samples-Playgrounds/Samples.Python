...
|  1 | Cockroach DB | An ACID-compliant, relational database that         |
...
|  2 | TiDB         | An open-source database that supports Hybrid        |
...
|  3 | YugabyteDB   | An open source, high-performance, distributed       |
...
|    |              | Cassandra.                                          |
|  4 | Vitess       | Vitess is a database solution for deploying,        |
