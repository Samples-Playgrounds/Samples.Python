...
|---:|:-----------------------------------|:-------------------------------------------------|
|  0 | 13 - API First                     | Make everything a service. Assume your code      |
|    |                                    | will be consumed by a front-end client, gateway, |
|    |                                    | or another service.                              |
|  1 | 14 - Telemetry                     | On a workstation, you have deep visibility into  |
...
|    |                                    | health/system data.                              |
|  2 | 15 - Authentication/ Authorization | Implement identity from the start. Consider      |
