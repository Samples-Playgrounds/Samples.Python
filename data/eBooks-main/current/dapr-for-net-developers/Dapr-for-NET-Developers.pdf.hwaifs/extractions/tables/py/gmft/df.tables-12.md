|    |       |                                                                                                                                                                 |
|---:|:------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  0 | nan   | http://localhost:<dapr-port>/v1.0/state/<store-name>/                                                                                                           |
...
|  4 | nan   | :::image type=“content” source=“./media/state-management/state-management-flow.png” alt￾text=“Diagram of storing a key/value pair in a Dapr state store.”:::    |
|  5 | nan   | Figure 5-1. Storing a key/value pair in a Dapr state store.                                                                                                     |
|  6 | nan   | Note the steps in the previous figure:                                                                                                                          |
