**Title:** Modernize-Existing-.NET-Applications-With-Azure-Cloud-And-Windows-Containers (v2.2)
**Authors:** Cesar de la Torre
**Language:** en
**Publisher:** Microsoft Corporation
**Date:** 0101-01-01T00:00:00+00:00
**Identifier:** 09dfdca1-53f8-4175-9b46-4018a27fc1aa
...
![A screenshot of a cell phone  Description automatically generated](images/image2.tiff)
...
Modernization scenarios      7

What this guide does not cover      9
...
Sample apps for modernizing legacy apps: eShopModernizing      11

Send your feedback      11

Lift and shift existing .NET apps to Azure IaaS (Cloud Infrastructure-Ready)      12

Why migrate existing .NET web applications to Azure IaaS      12

When to migrate to IaaS instead of to PaaS      13

Use Azure Migrate to analyze and migrate your existing applications to Azure      13

Use Azure Site Recovery to migrate your existing VMs to Azure VMs      14

Migrate your relational databases to azure      16

When to migrate to Azure SQL Database Managed Instance      16

When to migrate to Azure SQL Database      17

When to move your original RDBMS to a VM (IaaS)      18

When to migrate to SQL Server as a VM (IaaS)      18

**Lift and shift existing .NET apps to Azure IaaS (Cloud Infrastructure-Ready)****19**

Why migrate existing .NET web applications to Azure IaaS      20

When to migrate to IaaS instead of to PaaS      20

Use Azure Migrate to analyze and migrate your existing applications to Azure      20

Use Azure Site Recovery to migrate your existing VMs to Azure VMs      21

**Migrate your relational databases to azure****24**

When to migrate to Azure SQL Database Managed Instance      25

When to migrate to Azure SQL Database      26

When to move your original RDBMS to a VM (IaaS)      27

When to migrate to SQL Server as a VM (IaaS)      27

Use Azure Database Migration Service to migrate your relational databases to Azure      27

Additional resources      28

**Modernize existing .NET apps to Cloud-Optimized applications****29**

Reasons to modernize existing .NET apps to Cloud-Optimized applications      30

Cloud-Optimized application principles and tenets      30

Benefits of a Cloud-Optimized application      32

Microsoft technologies in cloud-optimized applications      32

Monolithic applications *can* be Cloud-Optimized      33

What about Cloud-Native applications?      34

Cloud-native applications details      35

What about microservices?      36

Deploy existing .NET apps as Windows containers      37

What are containers? (Linux or Windows)      37

Benefits of containers (Docker Engine on Linux or Windows)      37

What is Docker?      38

Benefits of Windows Containers for your existing .NET applications      39

Choose an OS to target with .NET-based containers      40

Windows container types      41

The container ecosystem in Azure      42

When not to deploy to Windows Containers      43

When to deploy Windows Containers in your on-premises IaaS VM infrastructure      44

When to deploy Windows Containers to Azure VMs (IaaS cloud)      44

When to deploy Windows Containers to Azure Container Instances (ACI)      45

When to deploy Windows Containers to Azure Container Service (that is, Kubernetes)      46

Choosing Azure compute platforms for container-based applications      46

Build resilient services ready for the cloud: Embrace transient failures in the cloud      47

Handling partial failure      48

Modernize your apps with monitoring and telemetry      49

Monitor your application with Application Insights      49

Monitor your Docker infrastructure with Log Analytics and its Container Monitoring solution      50

Modernize your app’s lifecycle with CI/CD pipelines and DevOps tools in the cloud      52

Migrate to hybrid cloud scenarios      53

Azure Stack      54

**Walkthroughs and technical get started overview****56**

Technical walkthrough list      56

Walkthrough 1: Tour of eShop legacy apps      57

Technical walkthrough availability      57
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image1-1.png](images/image.png)
...
![A screenshot of a cell phone  Description automatically generated](images/Screenshot_2019-08-29_at_23.46.52.png)

![A screenshot of text  Description automatically generated](images/Screenshot_2019-08-29_at_23.46.58.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image1-2.png](images/image-1.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image1-3.png](images/image-2.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image1-4.png](images/image-3.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image1-5.png](images/image-1.jpeg)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image1-6.png](images/image-2.jpeg)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image1-7.png](images/image-3.jpeg)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image2-1.png](images/image-4.jpeg)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image2-2.png](images/image-4.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image2-3.png](images/image-5.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\media\image3-1.png](images/image-6.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image1.png](images/image-6.jpeg)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image2.png](images/image-7.jpeg)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image3.png](images/image-8.jpeg)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image4.png](images/image-9.jpeg)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image6.png](images/image-9.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image7.png](images/image-10.png)
...
![A screenshot of a cell phone  Description automatically generated](images/image25.tiff)When you add the image name to your Dockerfile file, you can select the operating system and version by using a tag, as in the following examples for .NET Framework-based Windows container images:

![A screenshot of a social media post  Description automatically generated](images/image26.tiff)For .NET Core (cross-platform for Linux and Windows), the tags would look like the following:
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image7.5.png](images/image-11.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image8.5.png](images/image-12.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image9.png](images/image-13.png)
...
<https://docs.microsoft.com/dotnet/architecture/microservices/implement-resilient-applications/partial-failure-strategies>
...
• [https://docs.microsoft.com/previous-versions/msp-n-p/hh680934(v=pandp.50)](https://docs.microsoft.com/previous-versions/msp-n-p/hh680934%28v%3Dpandp.50%29)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image10.png](images/image-14.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image11.png](images/image-15.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image12.png](images/image-16.png)
...
![C:\dev\Github\docs-2\docs\architecture\modernize-with-azure-containers\modernize-existing-apps-to-cloud-optimized\media\image13.jpg](images/image-10.jpeg)
...
The full technical walkthrough is available in the eShopModernizing GitHub repo wiki: [https://github.com/dotnet-architecture/eShopModernizing/wiki/06.-Deploying-your-Windows-Containers-based-app-into-Azure-VMs-(Including-CI-CD)](https://github.com/dotnet-architecture/eShopModernizing/wiki/06.-Deploying-your-Windows-Containers-based-app-into-Azure-VMs-%28Including-CI-CD%29)
...
[Deploying the Apps to ACI (Azure Container Instances)](https://github.com/dotnet-architecture/eShopModernizing/wiki/05.-Deploying-the-Apps-to-ACI-%28Azure-Container-Instances%29)
