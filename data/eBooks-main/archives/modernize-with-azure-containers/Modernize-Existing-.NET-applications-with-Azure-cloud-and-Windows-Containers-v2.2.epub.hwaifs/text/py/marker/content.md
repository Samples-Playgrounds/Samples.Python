...
Modernize existing .NET applications with Azure cloud and Windows Containers (2.2.1 edition)
...
Lift and shift scenario 7

| Modernization scenarios<br>7                                                             |
|------------------------------------------------------------------------------------------|
| What this guide does not cover<br>9                                                      |
| Additional resources<br>10                                                               |
| Who should use this guide<br>10                                                          |
| How to use this guide<br>11                                                              |
| Sample apps for modernizing legacy apps: eShopModernizing<br>11                          |
| Send your feedback<br>11                                                                 |
| Lift and shift existing .NET apps to Azure IaaS (Cloud Infrastructure-Ready)<br>12       |
| Why migrate existing .NET web applications to Azure IaaS<br>12                           |
| When to migrate to IaaS instead of to PaaS<br>13                                         |
| Use Azure Migrate to analyze and migrate your existing applications to Azure<br>13       |
| Use Azure Site Recovery to migrate your existing VMs to Azure VMs<br>14                  |
| Migrate your relational databases to azure<br>16                                         |
| When to migrate to Azure SQL Database Managed Instance<br>16                             |
| When to migrate to Azure SQL Database<br>17                                              |
| When to move your original RDBMS to a VM (IaaS)<br>18                                    |
| When to migrate to SQL Server as a VM (IaaS)<br>18                                       |
| Lift and shift existing .NET apps to Azure IaaS (Cloud Infrastructure-Ready)<br>19       |
| Why migrate existing .NET web applications to Azure IaaS<br>20                           |
| When to migrate to IaaS instead of to PaaS<br>20                                         |
| Use Azure Migrate to analyze and migrate your existing applications to Azure<br>20       |
| Use Azure Site Recovery to migrate your existing VMs to Azure VMs<br>21                  |
| Migrate your relational databases to azure<br>24                                         |
| When to migrate to Azure SQL Database Managed Instance<br>25                             |
| When to migrate to Azure SQL Database<br>26                                              |
| When to move your original RDBMS to a VM (IaaS)<br>27                                    |
| When to migrate to SQL Server as a VM (IaaS)<br>27                                       |
| Use Azure Database Migration Service to migrate your relational databases to Azure<br>27 |
| Additional resources<br>28                                                               |
| Modernize existing .NET apps to Cloud-Optimized applications<br>29                       |
|                                                                                          |
| Reasons to modernize existing .NET apps to Cloud-Optimized applications<br>30            |
| Cloud-Optimized application principles and tenets<br>30                                  |

Monolithic applications *can* be Cloud-Optimized 33 What about Cloud-Native applications? 34 Cloud-native applications details 35 What about microservices? 36 Deploy existing .NET apps as Windows containers 37 What are containers? (Linux or Windows) 37 Benefits of containers (Docker Engine on Linux or Windows) 37 What is Docker? 38 Benefits of Windows Containers for your existing .NET applications 39 Choose an OS to target with .NET-based containers 40 Windows container types 41 The container ecosystem in Azure 42 When not to deploy to Windows Containers 43 When to deploy Windows Containers in your on-premises IaaS VM infrastructure 44 When to deploy Windows Containers to Azure VMs (IaaS cloud) 44 When to deploy Windows Containers to Azure Container Instances (ACI) 45 When to deploy Windows Containers to Azure Container Service (that is, Kubernetes) 46 Choosing Azure compute platforms for container-based applications 46 Build resilient services ready for the cloud: Embrace transient failures in the cloud 47 Handling partial failure 48 Modernize your apps with monitoring and telemetry 49 Monitor your application with Application Insights 49 Monitor your Docker infrastructure with Log Analytics and its Container Monitoring solution 50 Modernize your app's lifecycle with CI/CD pipelines and DevOps tools in the cloud 52 Migrate to hybrid cloud scenarios 53 Azure Stack 54 **Walkthroughs and technical get started overview 56** Technical walkthrough list 56 Walkthrough 1: Tour of eShop legacy apps 57 Technical walkthrough availability 57

Microsoft technologies in cloud-optimized applications 32

Overview 57

Goals 57

Scenario 1: ASP.NET Web apps 57

Scenario 2: WCF service and WinForms client app (3-Tier app) 58

Benefits 58

Next steps 58

Walkthrough 2: Containerize your existing .NET applications with Windows Containers 59

Overview 59

Goals 59

Scenario 1: Containerized ASP.NET web apps 59

Scenario 2: Containerized WCF service 60

Benefits 60

Next steps 60

Walkthrough 3: Deploy your Windows Containers-based app to Azure VMs 62

Technical walkthrough availability 62
...
Azure VMs for Windows Containers 64

Benefits 64

Next steps 64

Walkthrough 4: Deploy your Windows Containers-based apps to Azure Container Instances (ACI) 65

Technical walkthrough availability 65
...
Walkthrough 5: Deploy your Windows Containers-based apps to Kubernetes in Azure Container Service 67

Technical walkthrough availability 67
...
Walkthrough 6: Deploy your Windows Containers-based apps to Azure App Service for Containers 70

Technical walkthrough availability 70
...
| Cloud Infrastructure-Ready applications | Cloud Optimized applications                                                                                                                                   | Cloud-Native<br>applications                                                                                                               |
|-----------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| Lift and shift                          | Modernize                                                                                                                                                      | Modernize,<br>rearchitect/rewrite                                                                                                          |
|                                         | Application's compute target                                                                                                                                   |                                                                                                                                            |
| Applications deployed to VMs in Azure   | Monolithic or N-Tier apps<br>deployed to Azure App Service,<br>Azure Container Instance<br>(ACI), VMs with containers, or<br>AKS (Azure Kubernetes<br>Service) | Containerized microservices on<br>Azure Kubernetes Service<br>(AKS) and/or serverless<br>microservices based on Azure<br>Functions.        |
|                                         | Data target                                                                                                                                                    |                                                                                                                                            |
...
- Architect for the cloud, you get the best benefits from the cloud but new
- Microservices cloudnative approaches
- Modern mission-critical applications, cloudresilient hyper-scalable
...
Most existing .NET applications might nowadays be based on .NET Framework 4.x, or even on .NET Framework 3.5, and use web frameworks like ASP.NET MVC, ASP.NET Web Forms, ASP.NET Web API, Windows Communication Foundation (WCF), ASP.NET SignalR, and

ASP.NET Web Pages. These established .NET Framework technologies depend on Windows. That dependency is important to consider if you are simply migrating legacy apps and you want to make minimal changes to your application infrastructure.
...
[https://aka.ms/azuremigration\\\_datasheet](https://aka.ms/azuremigration%5C_datasheet)
...
If you have any other database (for example, IBM DB2) and you opt for a lift and shift approach, you might want to continue using those databases as IaaS VMs in Azure, unless you are willing to perform a more complex data migration. A more complex data migration

will require additional effort because you'd be migrating to a different database type with new schema and different programming libraries.
...
• **SQL Server database migration to SQL Database in the cloud** <https://docs.microsoft.com/azure/sql-database/sql-database-cloud-migrate>
...
The key is *agility*. You can't ship with agility unless you reduce to an absolute minimum any deployment-to-production issues and dev/test environment issues. Containers (specifically,

Docker, as a de facto standard) and managed services were designed specifically for this purpose.
...
- **Resilient application and infrastructure**. When you migrate to the cloud, you need to embrace transient failures; failures will occur in the cloud. Also, cloud infrastructure and

hardware are "replaceable," which increases opportunities for transient downtime. At the same time, inner cloud capabilities and certain application development techniques that implement resiliency and automate recovery make it much easier to recover from unexpected failures in the cloud.
...
# **Microsoft technologies in cloudoptimized applications**
...
The Cloud-Native modernization maturity level usually requires new development investments. Moving to the Cloud- Native level typically is driven by business need to modernize applications as much as possible to drastically improve scale in large applications by creating autonomous subsystems (microservices) that can be deployed and scale independently from other areas of the application while lowering costs in the long term and

increase evolution agility of those autonomous app's parts that provide significant compete advantages.
...
For a detailed look at a microservices architecture that you can implement by using .NET Core, see the downloadable PDF e-book [.NET microservices: Architecture for](https://aka.ms/microservicesebook) [containerized .NET applications.](https://aka.ms/microservicesebook) The guide also is available [online.](https://docs.microsoft.com/dotnet/architecture/microservices/)

But even in scenarios in which microservices offer powerful capabilities-independent deployment, strong subsystem boundaries, and technology diversity-they also raise many new challenges. The challenges are related to distributed application development, such as fragmented and independent data models; achieving resilient communication between

microservices; the need for eventual consistency; and operational complexity. Microservices introduce a higher level of complexity compared to traditional monolithic applications.
...
|----------------------------------------|--------------------------------------------|
| microsoft/dotnet-framework:4.x-        | .NET Framework 4.x on Windows Server Core  |
| windowsservercore                      |                                            |
| microsoft/aspnet:4.x-windowsservercore | .NET Framework 4.x with additional ASP.NET |
...
[https://info.microsoft.com/rs/157-GQE-382/images/](https://info.microsoft.com/rs/157-GQE-382/images/Container%20infographic%201.4.17.pdf)

[Container%20infographic%201.4.17.pdf](https://info.microsoft.com/rs/157-GQE-382/images/Container%20infographic%201.4.17.pdf)
...
From the container ecosystem in Azure, the following products supporting containers that are considered infrastructure: - **Azure Container Instances (ACI)** - **Azure Virtual Machines** (With container's support) - **Azure Virtual Machine Scale Sets** (With container's support)
...
For example, consider a monolithic .NET application that accesses a database in Azure SQL Database. If the Azure SQL database or any other third-party service is unresponsive for a

brief time (an Azure SQL database might be moved to a different node or server, and be unresponsive for a few seconds), when the user tries to do any action, the application might crash and show an exception at the same moment.
...
- **Implementing resilient communication to handle partial failure** [https://docs.microsoft.com/dotnet/architecture/microservices/implement-resilient](https://docs.microsoft.com/dotnet/architecture/microservices/implement-resilient-applications/partial-failure-strategies)[applications/partial-failure-strategies](https://docs.microsoft.com/dotnet/architecture/microservices/implement-resilient-applications/partial-failure-strategies)
- **Entity Framework connection resiliency and retry logic (version 6 and later)**

<https://docs.microsoft.com/ef/ef6/fundamentals/connection-resiliency/retry-logic>

- **The Transient Fault Handling Application Block**
- [https://docs.microsoft.com/previous-versions/msp-n-p/hh680934\(v=pandp.50\)](https://docs.microsoft.com/previous-versions/msp-n-p/hh680934(v=pandp.50))
...
The [Container Monitoring solution](https://docs.microsoft.com/azure/log-analytics/log-analytics-containers) in Log Analytics helps you view and manage your Docker and Windows Container hosts in a single location. The solution shows which containers are running, what container image they're running, and where containers are running. You can view detailed audit information, including commands that are being used with containers.

You also can troubleshoot containers by viewing and searching centralized logs, without needing to remotely view Docker or Windows hosts. You can find containers that might be noisy and consuming excess resources on a host. Additionally, you can view centralized CPU, memory, storage, and network usage, and performance information, for containers. On computers running Windows, you can centralize and compare logs from Windows Server, Hyper-V, and Docker containers. The solution supports the following container orchestrators:
...
[https://docs.microsoft.com/azure/operations-management-suite/operations-management](https://docs.microsoft.com/azure/operations-management-suite/operations-management-suite-overview)[suite-overview](https://docs.microsoft.com/azure/operations-management-suite/operations-management-suite-overview)
...
But you also can deploy to [Docker Swarm](https://blogs.msdn.microsoft.com/jcorioland/2016/11/29/full-ci-cd-pipeline-to-deploy-multi-containers-application-on-azure-container-service-docker-swarm-using-visual-studio-team-services/) or DC/OS by using Azure DevOps Services scriptbased tasks.
...
- **Active Directory Service Accounts for Windows Containers** [https://docs.microsoft.com/virtualization/windowscontainers/manage-containers/manage-](https://docs.microsoft.com/virtualization/windowscontainers/manage-containers/manage-serviceaccounts)
...
- **Azure Hybrid Benefit licensing** <https://azure.microsoft.com/pricing/hybrid-benefit/>
...
- Containerize your application by using [Visual Studio 2017 Tools for Docker](https://docs.microsoft.com/aspnet/core/host-and-deploy/docker/visual-studio-tools-for-docker) (Visual Studio 2017 or later versions).
- Containerize your application by manually adding a [Dockerfile](https://docs.docker.com/engine/reference/builder/), and then using the [Docker](https://docs.docker.com/engine/reference/commandline/cli/) [CLI](https://docs.docker.com/engine/reference/commandline/cli/).
...
[https://github.com/dotnet-architecture/eShopModernizing/wiki/Deploy-Windows-Container](https://github.com/dotnet-architecture/eShopModernizing/wiki/Deploy-Windows-Container-to-Azure-App-Service)[to-Azure-App-Service](https://github.com/dotnet-architecture/eShopModernizing/wiki/Deploy-Windows-Container-to-Azure-App-Service)
