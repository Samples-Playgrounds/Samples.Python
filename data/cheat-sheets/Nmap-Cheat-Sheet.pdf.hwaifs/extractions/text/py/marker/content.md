...
| -р                         | nmap -pU:110,T:23-25,443 172.16.1.1 | U-UDP,T-TCP different port types scan  |  |  |
| -p-                        | nmap -p- 172.16.1.1                 | Port scan for all ports                |  |  |
| -р                         | nmap -smtp,https 172.16.1.1         | Port scan from specified protocols     |  |  |
...
|------------------------------------------|------------------------------------------------------|
| nmapscript= test script<br>172.16.1.0/24 | execute thee listed script against target IP address |
...
|-------------------------------------------|--------------------------------|
| nmap -6                                   | scan IPV6<br>targets           |
| nmap -proxies proxy<br>1 URL, proxy 2 URL | Run in targets<br>with proxies |
