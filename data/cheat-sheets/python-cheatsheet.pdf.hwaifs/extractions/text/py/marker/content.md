...
\$ python -i my\_script.py

#### **Learn More on [realpython.com/search:](https://realpython.com/search)**

[interpreter](https://realpython.com/search?q=interpreter) ∙ run a [script](https://realpython.com/search?q=run+a+script) ∙ [command](https://realpython.com/search?q=command+line) line
...
[variables](https://realpython.com/search?q=variables) ∙ [assignment](https://realpython.com/search?q=assignment+operator) operator ∙ walrus [operator](https://realpython.com/search?q=walrus+operator)
...
[math](https://realpython.com/search?q=math) ∙ [operators](https://realpython.com/search?q=operators) ∙ built in [functions](https://realpython.com/search?q=built+in+functions)
...
[conditional](https://realpython.com/search?q=conditional+statements) statements ∙ [operators](https://realpython.com/search?q=operators) ∙ [truthy](https://realpython.com/search?q=truthy+falsy) falsy
...
define [functions](https://realpython.com/search?q=define+functions) ∙ return [multiple](https://realpython.com/search?q=return+multiple+values) values ∙ [lambda](https://realpython.com/search?q=lambda)
...
- .\_\_init\_\_() is the constructor method
...
object oriented [programming](https://realpython.com/search?q=object+oriented+programming) ∙ [classes](https://realpython.com/search?q=classes)
...
[list](https://realpython.com/search?q=list) ∙ [tuple](https://realpython.com/search?q=tuple) ∙ [set](https://realpython.com/search?q=set) ∙ [dictionary](https://realpython.com/search?q=dictionary) ∙ [indexing](https://realpython.com/search?q=indexing) ∙ [unpacking](https://realpython.com/search?q=unpacking)
...
[comprehensions](https://realpython.com/search?q=comprehensions) ∙ data [structures](https://realpython.com/search?q=data+structures) ∙ [generators](https://realpython.com/search?q=generators)
...
[files](https://realpython.com/search?q=files) ∙ [context](https://realpython.com/search?q=context+manager) manager ∙ [pathlib](https://realpython.com/search?q=pathlib)
...
[import](https://realpython.com/search?q=import) ∙ [modules](https://realpython.com/search?q=modules) ∙ [packages](https://realpython.com/search?q=packages)
...
virtual [environment](https://realpython.com/search?q=virtual+environment) ∙ [venv](https://realpython.com/search?q=venv)

#### **Packages**

The official third-party package repository is the Python [Package](https://pypi.org/) Index (PyPI)
...
- [Requirements](https://realpython.com/search?q=requirements.txt+python) Files in Python Projects
...
Continue your learning journey and become a Python expert at **[realpython.com/start-here](https://realpython.com/start-here/)**