...
If relevant, deobfuscate and examine macros,
JavaScript, or other embedded code.

5.

If relevant, emulate, disassemble and/or debug
...
from stream 3 in file.xls.

xmldump.py pretty

Format XML file supplied via
...
Display contents of object id. Add
...
Execute shellcode in file.bin to
...
characters in file to a string.
