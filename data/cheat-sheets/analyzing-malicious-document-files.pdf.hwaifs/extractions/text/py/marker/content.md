...
| List all OLE2 streams present<br>in file.xls.                                     |
|-----------------------------------------------------------------------------------|
|                                                                                   |
| Extract VBA source code<br>from stream 3<br>in file.xls.                          |
| Format XML file supplied via<br>STDIN for easier analysis.                        |
| Find obfuscated URLs<br>-p<br>plugin_http_heuristics<br>in file.xls<br>macros.    |
| Emulate the execution of macros<br>in file.doc to analyze them.                   |
| Remove the password prompt<br>from macros in file.ppt.                            |
| Decrypt outfile.docm<br>using<br>specified password<br>to create<br>outfile.docm. |
| Disassemble VBA-stomped<br>p-code macro from file.doc.                            |
| Decompile VBA-stomped<br>p-code macro from file.doc.                              |
| Extract objects embedded<br>into RTF file.rtf.                                    |
| List groups and structure of<br>RTF<br>file<br>file.rtf.                          |
| Examine objects in RTF file<br>file.rtf.                                          |
...
/XObject can embed an image for phishing. Be mindful of obfuscation with hex codes, such as
