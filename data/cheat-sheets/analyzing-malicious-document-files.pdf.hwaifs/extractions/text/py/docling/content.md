...
|---------------------------------------------------|---------------------------------------------------------------------------|
| zipdump.py file.pptx zipdump.py file.pptx -s 3 -d | Examine contents of OOXML file file.pptx . Extract file with index 3 from |
|                                                   | file.pptx to STDOUT.                                                      |
| olevba file.xlsm                                  | Locate and extract macros from file.xlsm .                                |

| oledump.py file.xls -i                                                                         | oledump.py file.xls -i                                                                         | List all OLE2 streams present in file.xls .                                                    |
|------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|
| oledump.py file.xls -s 3 -v                                                                    | oledump.py file.xls -s 3 -v                                                                    | Extract VBA source code from stream 3 in file.xls .                                            |
| xmldump.py pretty                                                                              | xmldump.py pretty                                                                              | Format XML file supplied via STDIN for easier analysis.                                        |
| oledump.py file.xls -p plugin_http_heuristics                                                  | oledump.py file.xls -p plugin_http_heuristics                                                  | Find obfuscated URLs in file.xls macros.                                                       |
...
| msoffcrypto-tool infile.docm outfile.docm -p                                                   | msoffcrypto-tool infile.docm outfile.docm -p                                                   | Decrypt outfile.docm using specified password to create outfile.docm .                         |
| pcodedmp file.doc                                                                              | pcodedmp file.doc                                                                              | Disassemble VBA-stomped p-code macro from file.doc .                                           |
| pcode2code file.doc                                                                            | pcode2code file.doc                                                                            | Decompile VBA-stomped p-code macro from file.doc .                                             |
| rtfobj.py file.rtf                                                                             | rtfobj.py file.rtf                                                                             | Extract objects embedded into RTF file.rtf .                                                   |
| rtfdump.py file.rtf                                                                            | rtfdump.py file.rtf                                                                            | List groups and structure of RTF file file.rtf .                                               |
| rtfdump.py file.rtf -O                                                                         | rtfdump.py file.rtf -O                                                                         | Examine objects in RTF file file.rtf .                                                         |
| rtfdump.py file.rtf -s 5 -H -d                                                                 | rtfdump.py file.rtf -s 5 -H -d                                                                 | Extract hex contents from group in RTF file file.rtf .                                         |
| xlmdeobfuscator --file file.xlsm                                                               | xlmdeobfuscator --file file.xlsm                                                               | Deobfuscate XLM (Excel 4) macros in file.xlsm .                                                |
| Risky PDF Keywords /OpenAction and /AA specify the script or action to run automatically.      | Risky PDF Keywords /OpenAction and /AA specify the script or action to run automatically.      | Risky PDF Keywords /OpenAction and /AA specify the script or action to run automatically.      |
| /JavaScript, /JS, /AcroForm, and /XFA can specify JavaScript to run.                           | /JavaScript, /JS, /AcroForm, and /XFA can specify JavaScript to run.                           | /JavaScript, /JS, /AcroForm, and /XFA can specify JavaScript to run.                           |
| /URI accesses a URL, perhaps for phishing.                                                     | /URI accesses a URL, perhaps for phishing.                                                     | /URI accesses a URL, perhaps for phishing.                                                     |
| /SubmitForm and /GoToR can send data to URL. /ObjStm can hide objects inside an object stream. | /SubmitForm and /GoToR can send data to URL. /ObjStm can hide objects inside an object stream. | /SubmitForm and /GoToR can send data to URL. /ObjStm can hide objects inside an object stream. |
...
| pdfid.py file.pdf -n                                                                                | Display risky keywords present in file file.pdf .                                                   | Display risky keywords present in file file.pdf .                                                   |
...
| qpdf --password=pass --decrypt infile.pdf outfile.pdf                                               | qpdf --password=pass --decrypt infile.pdf outfile.pdf                                               | Decrypt infile.pdf using password pass to create outfile.pdf .                                      |
| Shellcode and Other Analysis Commands                                                               | Shellcode and Other Analysis Commands                                                               | Shellcode and Other Analysis Commands                                                               |
| xorsearch -W -d 3 file.bin                                                                          | Locate shellcode patterns inside the binary file file.bin .                                         | Locate shellcode patterns inside the binary file file.bin .                                         |
...
| base64dump.py file.txt                                                                              | List Base64-encoded strings present in file file.txt .                                              | List Base64-encoded strings present in file file.txt .                                              |
| numbers-to- string.py file                                                                          | Convert numbers that represent characters in file to a string.                                      | Convert numbers that represent characters in file to a string.                                      |
