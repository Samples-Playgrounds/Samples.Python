...
| :set list :set nolist             | Show invisible characters Don't show invisible characters   |
|-----------------------------------|-------------------------------------------------------------|
| :set number :set nonumber         | Show line numbers Don't show line numbers                   |
| :set autoindent :set noautoindent | Indent after carriage return Turn off autoindent            |
| :set showmatch                    | Show matching sets of parentheses as they are typed         |
| :set noshowmatch                  | Turn off showmatch                                          |
| :set showmode :set noshowmode     | Display mode on last line of screen Turn off showmode       |
