# **Cascading Style Sheets Cheatsheet&66** page 1 of 2
...
Used to modify the size of the displayed font. H1 { font-size: large; } or P { font-size: 12pt; }
...
Defines an additional amount of space between characters. H1 { letter-spacing: 0.1em; }
...
OL { list-style-type: upper-alpha; } /\* A B C D E etc. \*/ OL OL { list-style-type: decimal; } /\* 1 2 3 4 5 etc. \*/
...
# **Cascading Style Sheets Cheatsheet (CSS 1&2)** page 2 of 2
...
Sets the margins of an element by specifying top, bottom, left and right margins -- all either specifying length or percentage. BODY { margin: 5em; } /\* all margins 5em \*/

P { margin: 2em 4em; } /\* top & bottom 2em, left & right 4em \*/ DIV { margin: 1em 2em 3em 4em; }
