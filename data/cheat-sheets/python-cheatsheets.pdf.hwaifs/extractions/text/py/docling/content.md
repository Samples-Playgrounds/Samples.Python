...
Select items at index 1 and 2 Select items a/fter index 0 Select items before index 3 Copy my\_list my\_list[list][itemOfList]
...
&gt;&gt;&gt; df.sort\_index() Sort by labels along an axis &gt;&gt;&gt; df.sort\_values(by='Country') Sort by the values along an axis &gt;&gt;&gt; df.rank() Assign ranks to entries
