...
import api_cunking_splitting_recursive_with_separators as api
...
def test_text():
   ...
   for text in texts:
      result_chunks = api.split_chunks_on_character_count(text, chunk_size)
...
def test_files():
   for source in sources:
      ...
      api.file_split_chunks_on_word_count_with_overlap(source)
      ...
      if source.endswith(".pdf"):
         ...
         for part_pdf in pdf_extracted_texts:
            ...
            file = f"{folder_results}/chunks-size-{chunk_size}.json"
