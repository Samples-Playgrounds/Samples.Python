...
def extract_tables_to_files (source: str) -> str:
    ...
    for i, table in enumerate(tables):
        ...
        df.to_csv(f"{source}.tables-{i}.camelot.csv")      # to_json, to_excel, to_html
        df.to_json(f"{source}.tables-{i}.camelot.json")    # to_json, to_excel, to_html
        df.to_excel(f"{source}.tables-{i}.camelot.xlsx")   # to_json, to_excel, to_html
        df.to_html(f"{source}.tables-{i}.camelot.html")    # to_json, to_excel, to_html
