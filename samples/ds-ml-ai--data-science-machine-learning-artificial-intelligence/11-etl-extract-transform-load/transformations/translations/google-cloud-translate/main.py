...
import api_translate_google_cloud_translate as api
...
# save to file
print(f"python: unstructured save {source}.google-cloud-translate.en.1.md")
with open(f"{source}.google-cloud-translate.en.1.md", "w") as f:
   f.write(result_txt) 


# now work with the markdown text, e.g. store as a UTF8-encoded file
import pathlib
print(f"python: unstructured save {source}..google-cloud-translate.en.2.md")
pathlib.Path(f"{source}.google-cloud-translate.en.2.md").write_bytes(result_txt.encode())
