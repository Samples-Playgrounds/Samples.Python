...
def api_parse_analyze_markdown_markdown_it_pyrs (source: str) -> str:
    """
    """
    #---------------------------------------------------------------------------
    ...
    directory = f"{source}.hwaifs/parse-analysis/py/markdown-it-pyrs/"
    ...
    try:
        ...
        tree = node.pretty(srcmap=True, meta=True)
